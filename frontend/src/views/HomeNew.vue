  ...
  <div class="pf-home">
    ...
    <section class="pf-hero">
      <div class="pf-hero-bg">
        <img
          src="https://images.unsplash.com/photo-1576671081837-49000212f370?w=1920&q=80"
      ...
      <div class="pf-container">
        <div class="pf-hero-content">
          <h1 class="animate-hero">REGULATORY<br/>INTELLIGENCE<br/>PLATFORM</h1>
          <p class="animate-hero-delay">制药·化妆品·食品行业知识与合规平台，覆盖政策法规、GMP 实务、药典解读等专业知识，AI 驱动，助力中国健康行业企业合规发展。</p>
          <div class="pf-hero-actions animate-hero-delay-2">
    ...
    <!-- Article List Section - Light blue background with Interactive Image -->
          ...
          <div class="pf-two-col-img">
            <div class="pf-img-interactive">
              <img
                ...
                alt="FDA warning letter document analysis"
    ...
    <!-- Features - Light blue bg with Interactive Image -->
    <section class="pf-section pf-section-light">
      <div class="pf-container">
        <div class="pf-two-col">
          <div class="pf-two-col-img">
...
onMounted(async () => {
  ...
  setTimeout(() => {
    document.querySelectorAll('.animate-hero, .animate-hero-delay, .animate-hero-delay-2').forEach(el => {
...
.pf-hero-overlay {
  position: absolute;
  inset: 0;
  background: linear-gradient(135deg, rgba(0,0,73,0.85) 0%, rgba(0,0,201,0.75) 50%, rgba(0,63,226,0.7) 100%);
}
...
.pf-section-light {
  background: linear-gradient(180deg, #F2F9FC 0%, #fff 100%);
}
...
.pf-section-header.revealed .pf-eyebrow {
  opacity: 1;
  transform: translateY(0);
}
...
.latest-article-card:hover {
  border-color: #0000C9;
  box-shadow: 0 8px 24px rgba(0,0,201,0.12);
...
.sector-entry-card:hover .sector-img-wrapper img {
  transform: scale(1.1);
}
...
.sector-entry-icon {
  ...
  align-items: center;
  justify-content: center;
  background: color-mix(in srgb, var(--sector-color) 10%, transparent);
...
.sector-entry-card .sector-entry-link {
  margin: 0 24px 20px;
}
...
.pf-img-interactive .interactive-img {
  width: 100%;
  aspect-ratio: 4/3;
  object-fit: cover;
...
.pf-img-interactive:hover .interactive-img {
  transform: scale(1.08);
}

.pf-img-interactive .interactive-badge {
  position: absolute;
  top: 16px;
  right: 16px;
  width: 48px;
  height: 48px;
  border-radius: 50%;
  background: linear-gradient(135deg, #0000C9 0%, #003FE2 100%);
  display: flex;
  align-items: center;
  justify-content: center;
  color: #fff;
  font-size: 14px;
  font-weight: 700;
  box-shadow: 0 4px 12px rgba(0,0,201,0.4);
  transform: scale(1);
  transition: transform 0.4s ease-out;
}

.pf-img-interactive:hover .interactive-badge {
...
.pf-stat-card {
  text-align: center;
  padding: 40px 24px;
  background: linear-gradient(135deg, #F2F9FC 0%, #fff 100%);
  border-radius: 8px;
...
.pf-stat-card:hover {
  transform: translateY(-4px);
  box-shadow: 0 8px 24px rgba(0,0,201,0.15);
